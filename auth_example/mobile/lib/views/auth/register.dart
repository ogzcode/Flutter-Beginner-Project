...
class _RegisterState extends State<Register> with AlertManager {
  String username = "";
  String email = "";
  String password = "";
  ...
  handleChangeInput(String input, String value) {
    setState(() {
      if (input == "username") {
        username = value;
        errorList.removeWhere((element) => element["field"] == "username");
      } else if (input == "email") {
        email = value;
        ...
        body: Column(
          ...
          children: [
            ...
            AuthInput(
                ...
                onChangeInput: handleChangeInput),
            AuthBtn(onAuthPressed: handleRegister, btnText: "Register"),
            const RedirectBtn(
                btnText: "Do you have an account? Login",
                redirectRoute: "/login"),
          ],
        ));
  }
